...
impl OrderApiUrl {
    ...
    fn get_order_by_id(&self, order_id: &str) -> String {
        format!("{}//api/v1/orders/{}", self.base_url, order_id)
    }

    fn get_order_status(&self, order_id: &str) -> String {
        format!("{}//api/v1/orders/{}/status", self.base_url, order_id)
    }

    fn get_order_by_tx_hash(&self, tx_hash: &str) -> String {
        format!("{}//api/v1/transactions/{}/orders", self.base_url, tx_hash)
    }

    fn get_trades(&self) -> String {
        format!("{}//api/v1/trades", self.base_url)
    }

    fn get_auction(&self) -> String {
        format!("{}//api/v1/auction", self.base_url)
    }

    fn get_user_orders(&self, account: &str) -> String {
    ...
    fn app_data_by_hash(&self, app_data_hash: &str) -> String {
    ...
    fn get_user_surplus(&self, account: &str) -> String {
